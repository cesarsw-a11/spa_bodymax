-- Ejecutar solo después de `20260329120000_service_variants` (tabla ServiceVariant y columna Booking.serviceVariantId).
...
-- AddForeignKey (SET NULL al borrar variante; coherente con campo opcional)
